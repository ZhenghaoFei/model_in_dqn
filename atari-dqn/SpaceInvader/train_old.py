...
SUMMARY_DIR = "./summary_spaceinvader_no_arg_k3"
...
def dual_model_mlayer(img_in, a_dim, scope, k=3, skip=True, reuse=False):
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        print "k = ", k
        print "ch_h = ", ch_h
        print "ch_state_1 = ", ch_state_1
        print "ch_state_2 = ", ch_state_2
            # print state
        # print a_dim
